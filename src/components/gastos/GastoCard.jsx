...
export default function GastoCard({ gasto, obras, categorias, subcategorias, etapasObra, fornecedores, onEdit, onDuplicate, isSelectMode, isSelected, onSelectToggle }) {
